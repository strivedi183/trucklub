...
t8 = Truck.create(:title => "Big Ds Grub Truck", :description => 'Asian Tacos', :twitter => 'bigdsgrub' , :phone => '+19146498398' , :image_url => 'http://farm6.static.flickr.com/5136/5493461896_e0d9160b5f.jpg', :about => "The tacos come 3 for $7, and theres plenty of food for your hard-earned lunch money. As for deciding which tacos to order, the choices are bulgogi beef, spicy pork, ginger chicken or spicy chicken.")
t9 = Truck.create(:title => 'GO Burger', :description => 'Burgers', :twitter => 'go_burger' , :phone => '+17175033849' , :image_url => 'http://newyorkstreetfood.com/wp-content/uploads/2012/02/truck2.jpg' , :about => "GO Burger is taking the gourmet burger experience on the road! Using the freshest, highest-quality ingredients, were serving up delicious burgers, sides and of course, milkshakes!")
t10 = Truck.create(:title => "Shortys NYC", :description => 'Cheesesteak', :twitter => 'shortysnyc' , :phone => '+17175033849' , :image_url => 'http://newyorkstreetfood.com/wp-content/uploads/2012/05/truck-window2.jpg' , :about => "We have taken The most important element of a cheesesteak, the bread and perfected it! We proudly serve our Cheesesteaks and other South Philly favorites on Philedelphias own LeBus Bakery Bread.")
t11 = Truck.create(:title => "Mexicue", :description => 'Mexican', :twitter => 'Mexicue' , :phone => '+19146498398' , :image_url => 'http://newyorkstreetfood.com/wp-content/uploads/2010/08/truck.JPG', :about => "Throwing modesty out the door, weve got to say youre probably going to freak out (we know because we did). Mexicue is the sweet, sweet love child of red-hot Mexican cuisine and down-home, barbeque goodness.")
t12 = Truck.create(:title => 'Wafles & Dinges', :description => 'Waffles', :twitter => 'waffletruck' , :phone => '+17175033849' , :image_url => 'http://tastytouring.com/wp-content/uploads/2010/09/wafel-dinges-trailer1.JPG', :about => "The Liege Waffle is the other Belgian waffle - the one the Belgians kept secret and never told anyone about! What makes them so different is the dough. Its made with a wheat-based yeast sweetened dough with pearl sugar, a sugar unique to Belgium that melts within.")
